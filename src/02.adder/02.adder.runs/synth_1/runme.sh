...
HD_PWD='D:/project/FPGA/src/02.adder/02.adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_4bit.tcl
