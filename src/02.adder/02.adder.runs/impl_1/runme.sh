...
HD_PWD='D:/project/FPGA/src/02.adder/02.adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_adder_4bit.tcl -notrace
