...
HD_PWD='D:/project/FPGA/src/01.gate_test/01.gate_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gate_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gate_test.tcl
