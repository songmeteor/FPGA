...
HD_PWD='D:/project/FPGA/src/01.gate_test/01.gate_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gate_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gate_test.tcl -notrace
